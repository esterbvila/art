...
export default function AboutArtist() {
  return (
    <section className="flex w-full flex-col bg-bg-warm md:h-[670px] md:flex-row lg:h-[600px]">
      ...
      {/* ── About text ────────────────────────────────────────────────── */}
      <div className="flex flex-col justify-center gap-5 px-5 pt-8 pb-10 md:p-10 lg:gap-6 lg:p-[72px]">
        {/* Label */}
        <p className="font-normal font-sans text-[13px] text-text-tertiary uppercase tracking-[3px]">The Artist</p>
