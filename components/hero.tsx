...
export default function Hero() {
  return (
    <section className="flex flex-col gap-8 px-5 pt-10 pb-0 md:gap-[56px] md:px-[48px] md:pt-[60px]">
      <div className="flex w-full flex-col gap-6 md:flex-row md:items-end md:justify-between">
        <h1
          className="w-full font-normal font-sans text-text-primary leading-tight95 md:max-w-[66%]"
          style={{
        ...
        <p
          className="font-normal font-sans text-text-secondary leading-[1.6] md:max-w-[280px] md:text-right lg:max-w-[300px] 2xl:max-w-[390px]"
      ...
      <div className="relative h-[250px] w-full overflow-hidden md:h-[350px] lg:h-[500px] xl:h-[550px] 2xl:h-[700px]">
        <Image
          src="/hero-img.webp"
