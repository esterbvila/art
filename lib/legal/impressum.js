/**
 * Impressum / Legal Notice — bilingual content.
...
export const impressumContent = {
  de: {
    ...
    sections: [
      ...
      {
        heading: 'Inhaltlich verantwortlich gemäß § 18 Abs. 2 MStV',
        body: (
          <p>
            Ester Batllori I Vila<br />
      ...
      },
      {
        ...
        body: (
          <p>
            ...
            Urheberrecht. Sämtliche abgebildeten Kunstwerke sind urheberrechtlich geschützt.
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: (
          <p>
            Tax number: 16/217/10332<br />
            VAT identification number pursuant to § 27a UStG: DE369468465
          </p>
        ),
      },
      {
        ...
        body: (
          <p>
            Freelance visual artist (sole trader), based in Berlin, Germany.
          </p>
        ),
      },
      {
        heading: 'Editorially responsible pursuant to § 18 (2) MStV',
        body: (
          <p>
            Ester Batllori I Vila<br />
            Riesestr. 11, 12347 Berlin
      ...
      },
      {
        ...
        body: (
          <>
            <p>
              The contents of this website have been prepared with the utmost care. However, no guarantee
              can be given for the accuracy, completeness or timeliness of the content. As a service
              provider, I am responsible for my own content on these pages in accordance with general laws
              pursuant to § 7 (1) TMG. As a service provider, however, I am not obliged to monitor
              transmitted or stored third-party information or to investigate circumstances that indicate
              illegal activity. Obligations to remove or block the use of information under general law
              remain unaffected (§§ 8–10 TMG).
            </p>
            <p>
              Despite careful review of content, I accept no liability for the content of external links.
      ...
      },
      {
        ...
        body: (
          <p>
            I am neither obliged nor willing to participate in dispute resolution proceedings before a
      ...
      },
      {
        ...
        body: (
          <p>
            The content and works created by me on these pages are subject to German copyright law. All
            artworks depicted are protected by copyright. Reproduction, editing, distribution and any form
            of exploitation beyond the limits of copyright law require my written consent.
          </p>
        ),
      },
    ],
