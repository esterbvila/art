    ...
    sections: [
      ...
      },
      {
        ...
        body: (
          <p>
            ...
            (vertragsbezogene Anfragen) sowie Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an
        ...
        body: (
          <>
            ...
            <p>
              ...
              Zugriffsdaten an Vercel übermittelt. Dabei können Daten in die USA übermittelt werden. Die
              Übermittlung erfolgt auf Grundlage des EU-US Data Privacy Frameworks, dem Vercel zertifiziert
      ...
      },
      {
        ...
        body: (
          <>
            <p>
              Diese Website verwendet ausschließlich technisch notwendige Speichermechanismen (z. B.
              Browser Local Storage), um die Funktionalität der Website sicherzustellen, etwa zur
              Speicherung des Warenkorbs. Es werden keine Tracking- oder Analysetechnologien eingesetzt.
            </p>
            <p>
      ...
      },
      {
        ...
        body: (
          <p>
            ...
            vertraulicher Inhalte, wie z. B. Bestellungen oder Anfragen, eine SSL-Verschlüsselung.
      ...
      },
      {
        ...
        body: (
          <>
            <p>
              Beim Besuch dieser Website werden vom Hosting-Anbieter automatisch Informationen in
              sogenannten Server-Logdateien erfasst und gespeichert. Dies kann folgende Daten umfassen:
            </p>
            <ul className="list-disc pl-5 flex flex-col gap-1">
              <li>IP-Adresse</li>
            ...
            <p>
              ...
              ausschließlich der technischen Stabilität und Sicherheit der Website.
            </p>
    ...
    sections: [
      ...
      },
      {
        ...
        body: (
          <p>
            ...
            basis is Art. 6 (1)(b) GDPR (contract-related enquiries) and Art. 6 (1)(f) GDPR
        ...
        body: (
          <>
            ...
            <p>
              ...
              access data are automatically transmitted to Vercel. Data may be transferred to servers
              in the United States. The transfer is based on the EU-US Data Privacy Framework, under
              which Vercel is certified. More information:{' '}
              <a href="https://vercel.com/legal/privacy-policy" className="text-accent hover:opacity-80 transition-opacity" target="_blank" rel="noopener noreferrer">
                vercel.com/legal/privacy-policy
              </a>
            </p>
      ...
      },
      {
        ...
        body: (
          <>
            <p>
              This website uses only technically necessary storage mechanisms (such as browser local
              storage) to ensure the functionality of the website, for example to store the shopping
              cart. No tracking or analytics technologies are used.
            </p>
            <p>
              These technologies are used on the basis of Art. 6 (1)(f) GDPR (legitimate interest in
      ...
      },
      {
        ...
        body: (
          <p>
            This website uses SSL encryption for security reasons and to protect the transmission of
            confidential content, such as orders or enquiries. You can recognise an encrypted
        ...
        body: (
          <>
            <p>
              ...
              information in so-called server log files. This may include:
            </p>
            <ul className="list-disc pl-5 flex flex-col gap-1">
              <li>IP address</li>
            ...
            <p>
              This data is not merged with other data sources and is used to ensure the technical
