...
import { getFeaturedArtwork } from "@/features/artwork/artwork-actions";
import { formatPrice } from "@/lib/utils";

export default async function FeaturedArtwork() {
  ...
  return (
    <section className="flex w-full flex-col bg-bg-deep md:h-140 md:flex-row">
      ...
      <div className="flex flex-col justify-center gap-5 px-5 py-8 md:w-125 md:shrink-0 md:px-14 md:py-16">
        <p className="font-normal font-sans text-[13px] text-text-light-muted uppercase tracking-wide3">
          Featured Work
        </p>
