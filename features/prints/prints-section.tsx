    ...
    <div className="flex flex-col gap-8 px-5 py-15 pb-20 md:gap-10 md:px-12">
      <div className="flex flex-col gap-1.5">
        <div className="flex w-full items-center justify-between">
          <span className="font-normal font-sans text-[16px] text-text-tertiary uppercase tracking-wide3">Prints</span>
        ...
        <p className="font-normal font-sans text-[12px] text-text-tertiary">
          Reproductions of original works, available in limited editions.
        </p>
      </div>
